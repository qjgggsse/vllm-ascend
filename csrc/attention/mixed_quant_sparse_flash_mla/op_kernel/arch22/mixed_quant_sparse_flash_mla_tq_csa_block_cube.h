...
/*!
 * \file mixed_quant_sparse_flash_mla_tq_csa_block_cube.h
 * \brief use 7 buffer for matmul l1, better pipeline
 */
#ifndef MIXED_QUANT_SPARSE_FLASH_MLA_TQ_CSA_BLOCK_CUBE_H
#define MIXED_QUANT_SPARSE_FLASH_MLA_TQ_CSA_BLOCK_CUBE_H
...
class KvQuantSparseFlashMlaCsaBlockCube {
public:
...
template <typename SAST>
__aicore__ inline void KvQuantSparseFlashMlaCsaBlockCube<SAST>::InitMm1GlobalTensor(GlobalTensor<Q_T> queryGm,
                                                                                    GlobalTensor<KV_T> oriKvGm,
                                                                                    GlobalTensor<KV_T> cmpKvGm,
                                                                                    GlobalTensor<MM_OUT_T> mm1ResGm)
{
...
template <typename SAST>
__aicore__ inline void KvQuantSparseFlashMlaCsaBlockCube<SAST>::InitMm2GlobalTensor(GlobalTensor<KV_T> vec1ResGm,
                                                                                    GlobalTensor<MM_OUT_T> mm2ResGm,
                                                                                    GlobalTensor<OUT_T> attentionOutGm)
{
    // mm2
...
template <typename SAST>
__aicore__ inline void KvQuantSparseFlashMlaCsaBlockCube<SAST>::AllocEventID()
{
...
template <typename SAST>
__aicore__ inline void KvQuantSparseFlashMlaCsaBlockCube<SAST>::FreeEventID()
{
