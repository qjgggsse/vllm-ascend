...
"""TTK result adapter for the MixedQuantSparseFlashMla pytest compare."""
...
class PytestResultComparator:
    ...
    def load_module(self):
        ...
        with self.lock:
            ...
            module_name = "mqsmla_ttk_pytest_compare"
            ...
            try:
                ...
                raise RuntimeError(
                    "Failed to load MixedQuantSparseFlashMla pytest compare; "
...
def compare(*outputs, compare_context=None, **_kwargs):
    """Run ordinary pytest precision; batch output checks run in phase two."""
    del compare_context
