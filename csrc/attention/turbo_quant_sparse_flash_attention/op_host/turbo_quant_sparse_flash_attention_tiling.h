...
struct TQSFARequiredParaInfo {
    const gert::CompileTimeTensorDesc *desc;
    const gert::StorageShape *shape;
};

struct TQSFAOptionalParaInfo {
    const gert::CompileTimeTensorDesc *desc;
...
struct TQSFAParaInfo {
    TQSFARequiredParaInfo query = {nullptr, nullptr};
    TQSFARequiredParaInfo key = {nullptr, nullptr};
    TQSFARequiredParaInfo value = {nullptr, nullptr};
    TQSFARequiredParaInfo sparseIndices = {nullptr, nullptr};
    TQSFAOptionalParaInfo blockTable = {nullptr, nullptr};
    TQSFAOptionalParaInfo actualSeqLengthsQ = {nullptr, nullptr};
    TQSFAOptionalParaInfo actualSeqLengths = {nullptr, nullptr};
    TQSFAOptionalParaInfo queryRope = {nullptr, nullptr};
    TQSFAOptionalParaInfo keyRope = {nullptr, nullptr};
    TQSFAOptionalParaInfo keyDequantScale = {nullptr, nullptr};
    TQSFAOptionalParaInfo valueDequantScale = {nullptr, nullptr};
    TQSFARequiredParaInfo attenOut = {nullptr, nullptr};
...
public:
    explicit TQSFAMlaTiling(gert::TilingContext *context) : context_(context) {}
...
public:
    explicit TQSFATilingCheck(const TQSFATilingInfo &qsfaInfo) : qsfaInfo_(qsfaInfo) {};
...
private:
    ...
    ge::graphStatus CheckDimNumInLayoutSupport(const TQSFALayout &layout,
        const gert::StorageShape *shape, const std::string &name) const;
    void LogErrorLayoutSupport(const std::vector<TQSFALayout> &expectLayoutList,
    ...
    ge::graphStatus CompareShape(TQSFATilingShapeCompareParam &param,
...
public:
    explicit TQSFAInfoParser(const gert::TilingContext *context) : context_(context) {}
