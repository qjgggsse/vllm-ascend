...
from golden import HEAD_DIM, N_CENT, golden_turbo_quant, make_centroids
...
def main():
    ...
    golden_y, golden_scale = golden_turbo_quant(latent, centroids)
    golden_y.tofile("golden_y.bin")
    golden_scale.tofile("golden_scale.bin")
